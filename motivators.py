...
motivators = [
    "Why don't we start by reflecting on the positive things!",
    ...
    "Remember: you've made it through every storm you've ever faced.",
    "Take a deep breath in and out.",
    "Don't worry too much on the outcome; what's your next right move?"
]
...
class HealthTrackerApp:
    ...
    def show_motivational_message(self):
        message = random.choice(motivators)
        print(message)
